...
> [!warning]- 作业提交格式（图片版状态图）
> 以下为提交版中使用的图片形式状态图，替代了上述 mermaid 代码块。
>
> **一、NFA 状态图：**
> - a) $(a|b)^*$：![[assets/或闭包状态图.jpg]]
> - b) $(a^*|b^*)^*$：![[assets/非确定自动机状态图.jpg]]
> - c) $((\epsilon|a)b^*)^*$：![[assets/自动机状态转换图.jpg]]
> - d) $(a|b)^*abb(a|b)^*$：![[assets/非确定有限自动机状态图.jpg]]
>
> **二、DFA 状态图：**
> - a) $(a|b)^*$：![[assets/确定有限自动机状态图.jpg]]
> - b) $(a^*|b^*)^*$：![[assets/有限自动机状态图.jpg]]
> - c) $((\epsilon|a)b^*)^*$：![[assets/使用构造法为下列正规式构造.jpg]]
> - d) $(a|b)^*abb(a|b)^*$：![[assets/确定型有限自动机状态图.jpg]]
=======
**完整序列：** $I_0, I_1, I_3, I_1, I_3, I_4, I_5, I_7$
