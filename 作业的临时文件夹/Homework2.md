...
![[Pasted image 20251011181430.png]]
**a.** 
(1,5), (2,5), (3,4), (3,5), (4,5)
...
# 6.4.1
Figure 6.4: 
![[Pasted image 20251012125603.png]]
![[Pasted image 20251012105508.png]]
![[Pasted image 20251012135441.png]]
- (a): 建堆之后的堆状态
- (b)-(i): 每次调用heapify后的堆状态, i指针指向heapify前堆尾位置, 这个位置将会存放堆首(堆最大值). 黄色节点代表堆外, 蓝色节点代表堆内
- (j) : 堆排序得到的有序数组A

# 6.5.9
![[Pasted image 20251012140742.png]]
